...
from .prompt_judge import PromptJudge
...
class testAgent:
    def __init__(self, llm: LLM):
        ...
        self.prompt_judge: PromptJudge | None = None
    ...
    def run_instance(self, spec: str) -> Tuple[bool, str]:
        ...
        print("#########################")
        assert self.prompt_judge
        
        self.prompt_judge.reset()
        answer, reasoning = self.prompt_judge.chat(spec)
        logger.info("Answer:")
        logger.info(answer)
    ...
    def _run(self, spec: str) -> Tuple[bool, str]:
        ...
        try:
            ...
            self.prompt_judge = PromptJudge(self.token_counter)
